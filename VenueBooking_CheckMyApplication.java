...
public class VenueBooking_CheckMyApplication extends Composite {
	...
	public class check extends SelectionAdapter {
		public void widgetSelected(SelectionEvent e) {
			...
			ArrayList<VenueApplicant> venueApplicantList = db
					.getVenueApplicantByMatricNo(matricNo); // same name, same
															// matric no, but
															// different
															// organization,
															// considered as two
			...
			if (matricNo.isEmpty()) {
				...
				applicationTable.removeAll(); // clear the table before loading
												// new information
	...
	public void fillApplicationTable(
