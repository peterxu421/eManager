...
public class ItineraryEditItem extends Composite {
	 ...
	 * @param style
	 */
	public ItineraryEditItem(Composite parent, int style, Table table, int index, Event event) {
		super(parent, style);
		...
		Label lblPageName = new Label(comp_eP_actual_itinerary_editPage, SWT.NONE);
	    ...
	    time = new DateTime(comp_eP_actual_itinerary_editPage, SWT.BORDER | SWT.TIME);
