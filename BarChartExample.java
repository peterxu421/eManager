...
public class BarChartExample {
	 ...
	 */
	public  BarChartExample(Composite parent, int style, Event event) {
		...
		for(int i = 0; i < listOfPeople.size(); i++) {
			stringOfPeople[i]=listOfPeople.get(i).getName(); //populating the stringOfPeople
...
public static void main(String[] args) {
	...
	BarChartExample bar = new BarChartExample(shell, SWT.None, event);
