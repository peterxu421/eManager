package eManager.eventSpace.facilitator;
...
import eManager.dataType.event.ManpowerAllocation;
...
public class EventPlanning_AllocationOfManpower extends Composite {
	...
	public EventPlanning_AllocationOfManpower(Composite parent, int style,
		...
		table_eP_facilitator_allocOfManpower = new Table(this, SWT.BORDER
				| SWT.FULL_SELECTION);
		...
		TableColumn col_eP_facilitator_allocOfManpower_task = new TableColumn(
				table_eP_facilitator_allocOfManpower, SWT.CENTER);
		col_eP_facilitator_allocOfManpower_task.setWidth(220);
		col_eP_facilitator_allocOfManpower_task.setText("Task");

		TableColumn col_eP_facilitator_allocOfManpower_assignedTo = new TableColumn(
				table_eP_facilitator_allocOfManpower, SWT.CENTER);
		...
		TableColumn col_eP_facilitator_allocOfManpower_dateDue = new TableColumn(
				table_eP_facilitator_allocOfManpower, SWT.CENTER);
		col_eP_facilitator_allocOfManpower_dateDue.setWidth(120);
		col_eP_facilitator_allocOfManpower_dateDue.setText("Date Due");

		TableColumn col_eP_facilitator_allocOfManpower_done = new TableColumn(
				table_eP_facilitator_allocOfManpower, SWT.CENTER);
	...
	public void importManpowerAllocationData() {
		...
		for (int i = 0; i < manpowerList.size(); i++) {
			TableItem temp = new TableItem(
					table_eP_facilitator_allocOfManpower, SWT.NULL);
