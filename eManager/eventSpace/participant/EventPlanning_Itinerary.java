package eManager.eventSpace.participant;
...
public class EventPlanning_Itinerary extends Composite {
	...
	public EventPlanning_Itinerary(Composite parent, int style, Event event) {
		super(parent, style);
