...
public abstract class AddItemSkeleton extends Composite {
	...
	public AddItemSkeleton(Composite parent, int style,
		...
		/*
		 * Composite compositeBtnAdd = new Composite(this, SWT.None); GridLayout
		 * gridLayoutBtnAdd = new GridLayout();
		 * compositeBtnAdd.setLayout(gridLayoutBtnAdd);
		 * gridLayoutBtnAdd.numColumns=1; gridLayoutBtnAdd.marginLeft=40;
		 * 
		 * Button btnAdd=new Button(compositeBtnAdd, SWT.None);
		 * btnAdd.setText("Add"); btnAdd.setLayoutData(new GridData(60,30));
		 * 
		 ...
		 * btnCancel.setText("Cancel"); btnCancel.setLayoutData(new
		 * GridData(60,30));
		 */
	}
	 ...
	 * Shell shell = new Shell(display); ArrayList<String> stringList = new
	 * ArrayList<String>(); stringList.add("a"); stringList.add("b");
	 * stringList.add("c"); AddItemSkeleton calc = new AddItemSkeleton(shell,
	 * SWT.NONE, stringList); calc.pack(); shell.pack(); shell.open(); while
