...
public class eP_facilitator_AllocOfManpower extends Composite {
	...
	public eP_facilitator_AllocOfManpower(Composite parent, int style, Event event) {
		...
		comp_eP_facilitator_allocOfManpower.setBounds(10, 10, 523, 310);
		...
		table_eP_facilitator_allocOfManpower.setBounds(10, 10, 418, 290);
		...
		col_eP_facilitator_allocOfManpower_task.setWidth(187);
		...
		col_eP_facilitator_allocOfManpower_assignedTo.setWidth(87);
		...
		col_eP_facilitator_allocOfManpower_dateDue.setWidth(91);
		...
		col_eP_facilitator_allocOfManpower_done.setWidth(49);
