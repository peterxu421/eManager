...
public class VenueBooking_BookingPage extends Composite {
	 ...
	 * @param style
	 */
	public VenueBooking_BookingPage(Composite parent, int style, Venue selected, ArrayList<BookedDateTime> bookedDateTimeList) {
		super(parent, style);
